...
import { Activity, Boxes, ChartNoAxesCombined, ClipboardCheck, Crosshair, Database, LayoutDashboard, Radar, Satellite, ScanSearch, Shield, Users, Waypoints } from 'lucide-react'
