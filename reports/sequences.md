...
- Manual sequences verified by an analyst: **4/4** (unique advisory ID, matching official title, source hash, and reviewed mappings are enforced by `scripts.validate_cert_in_sequences`).
- Prediction vocabulary: **622** distinct techniques
- Length: min 2 · mean 28.3 · max 131
